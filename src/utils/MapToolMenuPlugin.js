...
//人脸卡口
const renliankakou = "http://10.3.9.236:8892/hik8200-adapter/faceCamera/findFaceCameraPage"
//车辆卡口
const cheliangkakou = "http://10.3.9.236:8892/hik8200-adapter/vehicleBaseResource/findVehicleControlUnitPage"
//派出所
const paichusuo = "http://10.3.9.236:8892/sc/comprehensive/getAllPoliceStation"


//多维档案检索
const duoweidangan = "http://10.3.9.236:8892/sc/comprehensive/getArchives";
        ...
        if (type == "renliankakou") {
            if (mapInstance.mapComponet.haveMaker('renliankakou')) {
                ...
                ajax({
                    ...
                    success: function (data) {
                        console.log(data);
                        mapInstance.mapComponet.addAtMaker(data.data.pageData, 'renliankakou');
                    },
                    error: function (msg) {
                        console.log(msg);
                    },
            ...
            if (mapInstance.mapComponet.haveMaker('cheliangkakou')) {
                ...
                ajax({
                    ...
                    success: function (data) {
                        console.log(data);
                        mapInstance.mapComponet.addAtMaker(data.data.pageData, 'cheliangkakou');
            ...
            if (mapInstance.mapComponet.haveMaker('paichusuo')) {
                ...
                ajax({
                    ...
                    success: function (data) {
                        console.log(data);
                        mapInstance.mapComponet.addAtMaker(data.data, 'paichusuo');
            ...
            // var BMap=mapInstance.BMap;
            // var marker = new BMap.Marker(new BMap.Point(104.006378, 30.676592)); // 创建点
