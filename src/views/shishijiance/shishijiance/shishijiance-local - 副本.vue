    ...
    <div class="bl-content">
      ...
      <div class="content-right">
       ...
       <div class="pop">
        ...
        <el-dialog id="jcxq" title="监测详情" :visible.sync="jcxqpop" :before-close="resetData" width="84%" top="8vh" class="modal-popover">
                <div class="jcxq_content"  style="height:80vh">
                      <div class="ryxxpop_jbitem">
                        <div class="cxjg_item_left cxjg_item_right" style="height:100%;width:45%">
                          ...
                          <div style="padding:15px 15px 0 15px;display:flex;width:100%;height:calc(100% - 30px);"> 
                            <div class="jc-content" v-show="isShowSSJC">
                              ...
                              <div class="jc-chart" style='height:calc(100% - 70px);margin-top: 15px;'>
        ...
        <el-dialog :visible.sync="isShowQushiChart" width="600px" append-to-body class="modal-chart" top="30vh">
          <div class="chart_content" style="height:300px">
              <nmhc-chart v-if="isShowQushiChart" ref="nmhcChart" :code="curCode" :deviceCode="deviceCode"></nmhc-chart>
          </div>
        </el-dialog>
...
export default {
  ...
  methods: {
    selectByColor(states){
        ...
        //this.jcPoint;
        if(states==""){ this.$refs.jcChart.style.display="block";return;}
      ...
      return shipinApi
        ...
        .then(data => {
          if (data.transducer) {    
            ...
            _this.curVideoId = _this.indexs[0];
            if (_this.isShowNow) {
              _this.getDataNow();
    ...
    showVideo(tollgateID) {
      // tollgateID = tollgateID || this.curVideoId ||　'51011200101320100101';
