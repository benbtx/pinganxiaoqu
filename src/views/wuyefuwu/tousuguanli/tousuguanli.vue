            ...
            <div id="bukongsearchdiv" style="margin-top:10px;" v-show="srcresshow">
              <div class="model-hold">
                <el-table :data="srcTableData">
                  ...
                  <el-table-column prop="category" label="投诉类别" min-width="140">
                  </el-table-column>
                  <el-table-column prop="createtime" label="上报时间" min-width="150" >
                  </el-table-column>
                  <el-table-column prop="contacts" label="联系人" min-width="140">
                  </el-table-column>
                  <el-table-column prop="contactsphone" label="联系电话" min-width="140">
                  </el-table-column>
                  <el-table-column prop="state" label="处理状态" min-width="140">
                  </el-table-column>
                  <el-table-column prop="dealman" label="处理人" min-width="140">
                  </el-table-column>
                  <el-table-column label="操作" min-width="300" fixed='right'>
                    <template slot-scope="scope">
                      ...
                      <el-button type="text" size="small" class="operate-btn" @click="editbkdetail(scope.row)" v-if="scope.row.dealman==null">
    ...
    searchExcontrol: function(ctrcurrentPage) {
      ...
      return excontrolApi
        ...
        .then(data => {
          ...
          {
            if(this.srcTableData[i].state==0)
            {
              this.srcTableData[i].state="未处理";
            }
            else if(this.srcTableData[i].state==1)
            {
...
.add_bukong {
  background: url(../../../../static/image/wuyefuwu/tousudengji.png) no-repeat;
