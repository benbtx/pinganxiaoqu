<template>
  <div class="chart-all">
      ...
      <div class="line-h" id="sjxqsjtj-chart">
      </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    initChart(axisData, seriesData) {
      ...
      if (!barscase) {
        barscase = Ec.init(document.getElementById('sjxqsjtj-chart'));
      }
      barscase.setOption(option, true);
    },
    setChartResize () {
      let lineDom = document.getElementById('sjxqsjtj-chart');
