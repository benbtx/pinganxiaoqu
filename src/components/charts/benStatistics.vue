<template>
  <div class="chart-all">
      ...
      <div class="chart-content">
        ...
        <div class="line-h" id="ben-statistics-chart">
        </div>
      </div>
  </div>
</template>
...
export default {
  ...
  mounted() {
    let resultData = {
      axisData: ['00:00','01:00','02:00','03:00','04:00','05:00','06:00','07:00','08:00','09:00','10:00','11:00'],
      seriesData: [
        {
            name:'ben',
  ...
  methods: {
    ...
    initChart(axisData, seriesData) {
      ...
      if (!barscase) {
        barscase = Ec.init(document.getElementById('ben-statistics-chart'));
      }
      barscase.setOption(option, true);
    },
    setChartResize () {
      let lineDom = document.getElementById('ben-statistics-chart');
