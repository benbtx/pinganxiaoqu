<template>
  <div class="chart-all">
      ...
      <div class="chart-content">
        ...
        <div class="line-h" id="jiaben-statistics-chart">
        </div>
      </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    initChart(axisData, seriesData) {
      ...
      if (!barscase) {
        barscase = Ec.init(document.getElementById('jiaben-statistics-chart'));
      }
      barscase.setOption(option, true);
    },
    setChartResize () {
      let lineDom = document.getElementById('jiaben-statistics-chart');
